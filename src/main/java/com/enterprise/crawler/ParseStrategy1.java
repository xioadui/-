...
public class ParseStrategy1 extends AbstractParse {
    ...
    @Override
    public List<Information> parse() {
        List<Information> listInfo = parseUrl(this.url);

        for(Information i:listInfo) {
     ...
     */
    private List<Information> parseUrl(String url){
     ...
     * @return
     */
    private Information parseAPage(String pageUrl, Information info) {
        Document doc = null;
